							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{ route('register') }}" name="frm-login" method="post" >
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-lname" name="name" placeholder="Your full name*" :value="name" required autofocus autocomplete="name">
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address*</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="Your valid Email address" :value="email">
									</fieldset>
									<fieldset class="wrap-title">
